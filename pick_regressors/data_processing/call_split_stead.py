...
pref = "/uufs/chpc.utah.edu/common/home/koper-group1/alysha/Yellowstone/data/waveformArchive/stead_pickers"
catalog_df_filename = f"{pref}/SStead_800.csv"
catalog_h5_filename = f"{pref}/SStead_800.h5"
