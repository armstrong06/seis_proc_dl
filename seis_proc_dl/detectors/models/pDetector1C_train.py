...
if __name__ == "__main__":
    ...
    if (phase_type == "S"):
        ...
        learning_rate = 0.001 #7.e-5 # Try for S
    batch_size = 256
    model_path = "/home/armstrong/Research/normalized_noNGB_092013_072014/%s_models_%s_%s"%(phase_type, batch_size, learning_rate)
    print(model_path)
    print("learning rate", learning_rate)
    import h5py
    with h5py.File("data/train%s.%ds.%ddup.1C.h5"%(phase_type, duration, n_dup)) as f:
         X_train = f['X'][:]
         Y_train = f['Y'][:]
