...
pref = "/uufs/chpc.utah.edu/common/home/koper-group1/alysha/Yellowstone/data/waveformArchive/pPicker"
outdir = f'{pref}/p_picker_resampled_locationgrid/uuss'
...
current_earthquake_catalog_df = pd.read_csv(f'{pref}/current_earthquake_catalog_1c.csv')
current_earthquake_catalog_h5 = h5py.File(f'{pref}/current_earthquake_catalog_1c.h5', 'r')
historical_earthquake_catalog_df = pd.read_csv(f'{pref}/historical_earthquake_catalog_1c.csv')
historical_earthquake_catalog_h5 = h5py.File(f'{pref}/historical_earthquake_catalog_1c.h5', 'r')
current_blast_catalog_df = pd.read_csv(f'{pref}/current_blast_catalog_1c.csv')
current_blast_catalog_h5 = h5py.File(f'{pref}/current_blast_catalog_1c.h5', 'r')
...
X_test_eqc_h5, y_test_eqc_h5, test_eqc_df, NGB_data \
    = spliter.split_event_wise(current_earthquake_catalog_df, current_earthquake_catalog_h5,
                       train_size=0.7, validation_size=0.1, test_size=0.2, extract_event_bounds=bounds)
...
X_test_eqa_h5, y_test_eqa_h5, test_eqa_df \
    = spliter.split_event_wise(historical_earthquake_catalog_df, historical_earthquake_catalog_h5,
                       train_size=0.2, validation_size=0.01, test_size=0.79,
...
X_test_blc_h5, y_test_blc_h5, test_blc_df \
    = spliter.split_event_wise(current_blast_catalog_df, current_blast_catalog_h5,
                       train_size=0.8, validation_size=0.1, test_size=0.1,
