...
CFG = {
    ...
    "paths":{
        ...
        "output_dir": "/home/armstrong/Research/constant_boxcar_widths_NGB/applied_results_20141127/posterior_probs"
    },
    "models":{
    ...
    "output_file_names":{
        "catalog_file":"YNR",
        "output_probability_file":"YNR.probs.h5",
    },
    "swag_info":{
        "seeds": [1, 2, 3],
        "K": 20,
